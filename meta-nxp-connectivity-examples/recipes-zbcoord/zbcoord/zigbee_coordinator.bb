...
SRC_URI = "git://github.com/nxp-mcuxpresso/mcuxsdk-middleware-zigbee.git;branch=release/25.06.00-pvw2;protocol=https"
# SRC_URI += "file://0001-fix-imx-build-error.patch"
SRCREV = "58973027ead426a0879788cdbfc88e6246508dd3"
...
do_configure() {
    ...
    cmake ./ -DMACHINE_TYPE=imx8 -DCONFIG_MBEDTLS_SOURCE=GIT -DENABLE_TESTING=OFF -DENABLE_PROGRAMS=OFF -DCMAKE_POLICY_VERSION_MINIMUM=3.5
}
